...
$NugetTemplate = Join-Path $PSScriptRoot "NugetLoaderTemplate"
...
$xml.SelectSingleNode("/ng:package/ng:metadata/ng:dependencies/ng:dependency[@id='OpenXR.Headers']/@version", $nsm).InnerText = $SDKVersion
$xml.Save($NuSpecPath)
